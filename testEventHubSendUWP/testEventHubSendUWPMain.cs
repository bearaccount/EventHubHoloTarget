...
using testEventHubSendUWP.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using testEventHubSendUWP.Content;
#endif
...
namespace testEventHubSendUWP
{
    ...
    /// </summary>
    internal class testEventHubSendUWPMain : IDisposable
    {
        ...
        // <<NEW>> Manage Event Hub Sends
        public EventHubSend eventHubSend;

        /// <summary>
        /// Loads and initializes application assets when the application is loaded.
        /// </summary>
        /// <param name="deviceResources"></param>
        public testEventHubSendUWPMain(DeviceResources deviceResources)
        {
